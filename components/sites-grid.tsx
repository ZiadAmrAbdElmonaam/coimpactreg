...
const sites: Site[] = [
  ...
  { country: "Australia", city: "Melbourne", hospital: "Peter Mac" },
  ...
  { country: "Italy", city: "Milano", hospital: "IEO" },
