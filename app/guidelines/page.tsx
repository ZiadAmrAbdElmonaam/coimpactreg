        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            <table className="w-full border-collapse border border-gray-300">
              <tbody>
                <tr>
                  <td className="border border-gray-300 p-2 w-1/3">Date</td>
                  <td className="border border-gray-300 p-2 w-1/3">Issued by</td>
                  <td className="border border-gray-300 p-2 w-1/3">Approved by</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 p-2">Date</td>
                  <td className="border border-gray-300 p-2">Constantinos Zamboglou</td>
                  <td className="border border-gray-300 p-2">All Co-IMPACT PIs (23.12.2024)</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 p-2">Date</td>
                  <td className="border border-gray-300 p-2">Review</td>
                  <td className="border border-gray-300 p-2">Approved by</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 p-2"></td>
                  <td className="border border-gray-300 p-2">Reviewer&apos;s name</td>
                  <td className="border border-gray-300 p-2">Director&apos;s name</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 p-2"></td>
                  <td className="border border-gray-300 p-2">Reviewer&apos;s name</td>
          ...
          <div className="space-y-6 text-gray-700">
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2">5.2 Approval of new study centers</h3>
                  <p className="mb-3">Centers interested in participating in Co-IMPACT may apply by directly contacting a Principal Investigator (PI) or through the Co-IMPACT website (currently under development). Applications must follow a designated template (see attachment 1, center application form), which should include the names of the primary local participants, the expected number of patients, the need for a signed DTA and the approximated time to complete a DTA, the sub-projects of interest, and confirmation regarding the ability to share DICOM data. Furthermore, applicants are required to reference any prior publications relevant to the consortium&apos;s focus areas.</p>
                  <p>Each application will be shared within the consortium PIs and a majority vote is needed to include a center. Upon this step, the approved new center will receive the DTA, the study protocol and the data exchange files.</p>
                </div>

                <div>
                  <h3 className="text-lg font-semibold mb-2">5.3 Authorship rights</h3>
                  <p className="mb-3">1. First/Last Authorships For each paper resulting from a pre-specified analysis using the Co-IMPACT database, the responsible institution(s) are defined. This/These institution(s) is/are allowed to name the first and last authors.</p>
                  <p className="mb-3">2. Co-authors All Co-IMPACT PIs of the respective sub-project must be named as Co-authors in the main author line. The policy considers the number of patients included in each sub-project (Co-IMPACT 1-4) according to the following co-authorship guidelines:</p>

                  <div className="pl-4 mb-3">
                    <h4 className="font-medium mb-2">Papers Including Only Clinical Data</h4>
                  ...
                  <div className="pl-4 mb-3">
                    <h4 className="font-medium mb-2">Papers Including Clinical and Imaging Data</h4>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <p className="mt-2 text-sm italic">* Depending on journal restrictions on the number of authors in the main author line, the responsible institutions for the respective analysis are allowed to name up to additional 1-3 authors for the main author line. The Co-IMPACT PIs remain in the main author line.</p>
                  </div>
                </div>

                <div>
                  <h3 className="text-lg font-semibold mb-2">5.3 Changes of the study protocol, DTA or data exchange files</h3>
                  <ul className="list-disc pl-6 space-y-2">
                  ...
                  <p className="mt-2">These rules apply for changes in the study protocol, the DTA and the data exchange files.</p>
                  <p className="mt-2">(Minor adjustments may be collected and incorporated into a protocol amendment at a later stage to minimize bureaucratic overhead.)</p>
                </div>

                <div>
                  <h3 className="text-lg font-semibold mb-2">5.4 Clinical data submission and initial quality check</h3>
                  <ul className="list-disc pl-6 space-y-2">
